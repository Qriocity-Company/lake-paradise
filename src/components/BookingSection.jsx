    ...
    <div id='book' className='w-full flex flex-col items-center mb-8 md:mb-12'>
      <div className='w-[100%] md:w-[100%] flex flex-col bg-[#E9F3F6] p-4 md:p-8 '>
        ...
        <form className='flex flex-col w-full' onSubmit={handleSubmit}>
          ...
          <div className='block mac:flex md:gap-8 lg:gap-12 mt-8'>
            <div className='w-full mac:w-[60%]'>
              <CalendarUI />
            </div>
            <div className='w-full mac:w-[40%] mt-6 md:mt-0 flex flex-col justify-between gap-4 md:gap-0'>
              ...
              <div className='flex items-center gap-2'>
                ...
                <div className='flex flex-col gap-2 w-full'>
                  <label htmlFor="country" className='w-full font-semibold text-base lg:text-lg'>Promo Code (if any)</label>
                  <input
                    id="promoCode"
                    name="promoCode"
          ...
          <div className='flex flex-col md:grid grid-cols-3 gap-4 mt-4 md:mt-4'>
